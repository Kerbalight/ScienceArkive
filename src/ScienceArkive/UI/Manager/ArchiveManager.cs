...
namespace ScienceArkive.UI.Manager
{
    public class ArchiveManager
    {
        ...
        {
            if (!GameManager.Instance.Game.SessionManager.TryGetDifficultyOptionState<float>("ScienceRewards", out var scienceMultiplier))
            {
                    ...
                    if (region != null)
                    {
                        switch (location.ScienceSituation)
                        {
                            ...
                            case ScienceSitutation.HighOrbit:
                                ...
                                break;
                            default:
                                logger.LogWarning($"GetResearchLocationScalar: Unknown situation for region: {location.ScienceSituation}");
                                break;
                        }
                    }
                    else
